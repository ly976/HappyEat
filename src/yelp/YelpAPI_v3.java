...
//            connection.setRequestProperty("User-Agent", "Mozilla/5.0");
    ...
    /**
     *  Create and sends a request to the Search API by term and location
     */
...
//            connection.setRequestProperty("Authorization", TOKEN_TYPE + " " + access_token); // Removed as Yelp changed the way to request access token
     ...
     */
    private static void queryAPI(YelpAPI_v3 yelpApi, double lat, double lon) {
    ...
    /**
     *  Main entry for saple Yelp API requests
     */
    public static void main(String[] args) {
    	YelpAPI_v3 yelpApi = new YelpAPI_v3();
        queryAPI(yelpApi, 37.38, -122.08); // San Francisco
    }
}
